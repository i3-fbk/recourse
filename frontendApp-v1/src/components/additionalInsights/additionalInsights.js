                ...
                <div className="AiTitleOfBox">
                  <div style={{textAlign: 'left'}}>
                    ...
                    <small className="differencesAmount">
                      {configuration[item.name]?.valuesWithLabel ? configuration[item.name]?.valuesWithLabel[item.valueDiff] : item.valueDiff}                
                    </small>
                  </div>
                    ...
                    <Slider
                      ...
                      onChange={(event) =>
                        handleScalerChange(
                          event,
                          planIndex,
                          configuration[item.name].dataset
                        )
                      }
                  ...
                  <div className="input-container">
                    {item.type === "numeric" ? (
                      ...
                      <Select
                        ...
                        style={{ maxWidth: 340 }}
                      >
                        {configuration[item.name].valuesWithLabel
                          ? Object.entries(
                              configuration[item.name].valuesWithLabel).map((option) => (<MenuItem key={option[0]} value={option[0]}>
                                <Checkbox
                                  checked={(selectedOptions[planIndex] || []).indexOf(
                                    option[0]
                                  ) > -1}
                                />
