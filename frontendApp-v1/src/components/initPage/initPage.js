      ...
      <div className="topMessage">
        <Grid item className="userName">
          ...
          <div className="GeneralSubTitle">
            ...
            impersonate. As mentioned earlier, the persona's loan request has
            been declined. Your task is to engage with the platform as if you
            were this individual, seeking to find a compromise between her
            preferences and the attainment of the desired loan. To proceed,
            begin by clicking the "Request a Recourse Plan" button.
          </div>
        </Grid>
      </div>
      {isLoading ? (
              ...
              <div key={index} className="descriptionIconAndInput">
                <TextField
                 ...
                 // value={mergedDataset[feature] || "" || 0}
                  value={dataset[feature]?.valuesWithLabel ? dataset[feature]?.valuesWithLabel[mergedDataset[feature]] : mergedDataset[feature]}
                />
