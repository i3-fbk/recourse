...
function LoginPagePersonaTwo() {
  ...
  function handleLogin() {
    ...
    if (selectedOption === 'yes'){
		recourseFareWebApi
      .get("/get_user?persona_id=2", { user_id: userID })
      .then((res) => {
        if (res.data) {
    ...
    <div className="page-container">
      <div style={{ margin:' 10px 60px'}}>
        ...
        <p style={{ textAlign: "justify" }}>
          ...
          financial institution; however, regrettably, his request is declined.
          This is precisely where our platform intervenes to provide assistance.
          Through a comprehensive analysis of his data and preferences, we offer
          tailored plans for his consideration. thereby enhancing the likelihood
        ...
        <p>
          ...
          <span style={{ fontWeight: 700, fontSize: 18, color: "#000", padding: '0px 8px'}}>
            this person
          </span>
          who submitted the loan application and had his application has been
          <storng style={{ fontWeight: 700, fontSize: 18, color: "#000", padding: '0px 8px' }}>
            declined
          </storng>
          :
        </p>
        <ul>
          ...
          <li>Occupation: Professional specialty (50 hours per week)</li>
          <li>Marital status: Never married, no dependent</li>
          <li>Annual income: $82,000</li>
        </ul>
        <p>The loan that you requested is: $30,600</p>
        <br />
        <p style={{ textAlign: "justify" }}>
          ...
          aiming to strike a balance between his preferences and the achievement
          of the desired loan.
        </p>
...
export default LoginPagePersonaTwo;
